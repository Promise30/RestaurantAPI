        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryFee = table.Column<decimal>(type: "decimal(18,0)", precision: 18, scale: 0, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Restaurants_Delivery_DeliveryId",
                        column: x => x.DeliveryId,
                        principalTable: "Delivery",
                        principalColumn: "DeliveryId");
                    table.ForeignKey(
                        name: "FK_Restaurants_LocalGovernments_LocalGovernmentId",
                        column: x => x.LocalGovernmentId,
                        principalTable: "LocalGovernments",
                        principalColumn: "LocalGovernmentId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "LocalGovernmentId", "Name", "StateId" },
                values: new object[,]
                {
                    { 1, "Aba North", 1 },
                    { 2, "Aba South", 1 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuTypes_RestaurantId",
                table: "MenuTypes",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_Restaurants_DeliveryId",
                table: "Restaurants",
                column: "DeliveryId");

            migrationBuilder.CreateIndex(
                name: "IX_Restaurants_LocalGovernmentId",
                table: "Restaurants",
